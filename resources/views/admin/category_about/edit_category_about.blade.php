...
?>
    <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/category_about')}}">Danh mục giới thiệu</a></li>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <!-- form start -->
                <form role="form" method="post" action="{{ url('admin/do_edit_category_about') }}/{{ $arr->pk_category_about_id }}" enctype="multipart/form-data">
                	{!! csrf_field() !!}
                  ...
                  <div class="box-footer">
                    ...
                    <a href="{{ url('/admin/category_about')}}"><button type="button" class="btn btn-primary"><i class="fa fa-undo" aria-hidden="true"></i> Trở về</button></a>
                  </div>
                </form>
              </div><!-- /.box -->
