...
?>
		<section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/category_other')}}">Danh mục dịch vụ  khác</a></li>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <!-- form start -->
                <form role="form" method="post" action="{{ url('admin/do_edit_category_other') }}/{{ $arr->pk_category_other_id }}" enctype="multipart/form-data">
                	{!! csrf_field() !!}
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" value="{{ $arr->c_icon }}" class="form-control" id="c_keyword" placeholder="Icon cho danh mục" required name="c_icon"  >
                      <br>
                      <b>{!! $arr->c_icon !!} {{ $arr->c_name }}</b>
                      <br>
                     ...
                     <div class="form-group">
                      ...
                      <div class="radio">
                        <label>
                          <input type="radio" name="c_enable" id="optionsRadios" value="1" @if($arr->c_enable == 1) checked @endif >
                            Enabel(hiện)
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="c_enable" id="optionsRadios" value="0" @if($arr->c_enable == 0) checked @endif>
                            Disenable(ẩn)
                        </label>
                      </div>
                  ...
                  <div class="box-footer">
                    ...
                    <a href="{{ url('/admin/category_other')}}"><button type="button" class="btn btn-primary"><i class="fa fa-undo" aria-hidden="true"></i> Trở về</button></a>
                  </div>
                </form>
              </div><!-- /.box -->
