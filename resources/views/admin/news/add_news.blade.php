          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <!-- form start -->
                <form role="form" method="post" action="{{ url('admin/do_add_news') }}" enctype="multipart/form-data">
                	{!! csrf_field() !!}
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <div class="radio">
                        <label>
                          <input type="radio" name="c_category_news" id="optionsRadios" value="1" checked>
                            Tin ATTP trong nước
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="c_category_news" id="optionsRadios" value="0" >
                            Tin ATTP ngoài nước
                        </label>
                      </div>
