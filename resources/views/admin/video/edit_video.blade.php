          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <!-- form start -->
                <form role="form" method="post" action="{{ url('admin/do_edit_video') }}/{{ $arr->pk_video_id }}" enctype="multipart/form-data">
                	{!! csrf_field() !!}
                  ...
                  <div class="box-body">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="c_code" required name="c_code" value="<?php if(isset($arr->c_code)) echo $arr->c_code ?>" placeholder="Mã video của vimeo">
                      ...
                      <iframe src="https://player.vimeo.com/video/<?php if(isset($arr->c_code)) echo $arr->c_code ?>?title=0&byline=0&portrait=0" frameborder="0"  webkitallowfullscreen mozallowfullscreen allowfullscreen  ></iframe>
                      <br>
                    ...
                    <div class="form-group">
                      ...
                      <br>
                      <a href="https://vimeo.com/<?php if(isset($arr->c_code)) echo $arr->c_code ?>" target="_blank"><button type="button" class="btn btn-sm btn-info"><i class="fa fa-cloud-upload" aria-hidden="true"></i> Upload video</button></a>
                    </div>
